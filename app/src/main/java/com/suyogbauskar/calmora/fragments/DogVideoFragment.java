...
/**
 * Fragment that plays a fear of dogs video in fullscreen landscape mode.
...
public class DogVideoFragment extends Fragment {
    ...
    private static final String TAG = "DogVideoFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dog_video, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        videoView = view.findViewById(R.id.dog_video_player);
        
        // Set the video source from raw resources
        String videoPath = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.cynophobia;
