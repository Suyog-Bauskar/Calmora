...
/**
 * Fragment that plays a claustrophobia (fear of closed spaces) video in fullscreen landscape mode.
 * The video will automatically play and loop continuously.
 */
public class SpaceVideoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_space_video, container, false);
    }
