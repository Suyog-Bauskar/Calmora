...
/**
 * Fragment that plays a fear of water video in fullscreen landscape mode.
 * The video will automatically play and loop continuously.
 */
public class WaterVideoFragment extends Fragment {
    ...
    private static final String TAG = "WaterVideoFragment";

    public WaterVideoFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_water_video, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        videoView = view.findViewById(R.id.water_video_player);
        
        // Set the video source from raw resources
        String videoPath = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.hydrophobia;
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (videoView != null) {
            if (isVisibleToUser && !isExternallyControlled) {
                videoView.start();
            } else {
                videoView.pause();
            }
