...
/**
 * Fragment that plays a fear of spiders video in fullscreen landscape mode.
 * The video will automatically play and loop continuously.
 */
public class SpiderVideoFragment extends Fragment {
    ...
    private static final String TAG = "SpiderVideoFragment";

    public SpiderVideoFragment() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        videoView = view.findViewById(R.id.spider_video_player);
        
        // Set the video source from raw resources
        String videoPath = "android.resource://" + requireActivity().getPackageName() + "/" + R.raw.arachnophobia;
